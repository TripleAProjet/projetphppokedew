...
echo '<center><div class="alert alert-primary alert-dismissible fade show" role="alert">
...
<main>
  ...
  <img id="imgindex" src="images/pikachu.png" alt="">
  <h1 id="titreindex">BIENVENUE SUR LE POKEDEX DE L'ESGI !<h1>
